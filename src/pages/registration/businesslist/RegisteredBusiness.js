...
import swal from "sweetalert";
 ...
 const RegisteredBusiness=({GetRegisteredBusiness, registeredBusinessList}) => {
     ...
     useEffect(() => {
         ...
         const { registeredError, registeredNetworkError, registeredMessage} = registeredBusinessList;
         ...
         <main className="mt-2 mt-md-5 container-lg d-flex flex-column justify-content-center align-items-center">
             ...
             <article className="py-4 px-2 py-md-5 px-md-4 biz_cont">
                 <div className="heading-cont">
                     ...
                     <p className="mt-3 mb-4 heading-subtext">Choose from the list of registered business
                     </p>
                 </div>

                 <div className="row pb-lg-5 justify-content-center">

                     {registeredBusinessList.registeredSuccess && <BusinessList business={registeredBusinessList.registeredData} />}
