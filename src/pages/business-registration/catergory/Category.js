            ...
            <main className="mt-2 mt-md-5 container d-flex flex-column ">
                <article className="py-4 px-2 py-md-5 px-md-1">
                    <div className="heading-cont">
                        ...
                        <p className="mt-3 mb-4 heading-subtext">Choose the business you want to transact now.
                        </p>
                    </div>
                    ...
                    <div className="mt-5 mb-3 d-flex justify-content-center">
                        <Button onClick={ChangePage} disabled={!name ? true : false} name='CONTINUE' styles='btn text-white p-3 category_btn' type='button' />
