...
const BusinessOverview = ({ CompanyDetails, business }) => {
    ...
    return <FormContainer name='Finish' desc='Choose the business you want to transact now.' pageName='Finish'>
        <form class="px-3 mt-5 pp_form" >
            ...
            <p>This account is specifically for you and connected to Aimienpay. For security reasons, you can only fund this account from any bank account that has the account name. Spacepen Technologies</p>
            <p>You can setup your business and add your employees. Click on FINISH to continue</p>
            </div>
           
            <div class="mb-3 mt-5 button_container d-flex justify-content-center">
                <Button name='FINISH' onClick={()=> navigate('/registered-business')} type='button' styles='btn text-white py-3 px-3 category_btn' />
            </div>
